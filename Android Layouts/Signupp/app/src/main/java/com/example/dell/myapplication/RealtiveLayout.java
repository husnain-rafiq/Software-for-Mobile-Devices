        ...
        registerButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                if (editText1.getText().toString().equals("")) {
                    Toast.makeText(RealtiveLayout.this, "Please Enter User_name", Toast.LENGTH_SHORT).show();
                }
                else {
                    flag1=true;
                }
                ...
                if (editText2.getText().toString().equals("")) {
                    Toast.makeText(RealtiveLayout.this, "Please Enter Email or Contact Number", Toast.LENGTH_SHORT).show();
                }
                else {
                    flag2=true;
                }
                ...
                if (editText3.getText().toString().equals("")) {
                    Toast.makeText(RealtiveLayout.this, "Please Enter the Password", Toast.LENGTH_SHORT).show();
                }
                else {
                    flag3=true;
                }
                ...
                if (radioGroup.getCheckedRadioButtonId() == -1) {
                    Toast.makeText(RealtiveLayout.this, "Please Select the Gender", Toast.LENGTH_SHORT).show();
                } else {
                    flag4=true;
