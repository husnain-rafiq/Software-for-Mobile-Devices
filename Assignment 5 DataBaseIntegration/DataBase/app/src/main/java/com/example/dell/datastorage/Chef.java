        ...
        btnAddData.setOnClickListener(
                new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        {
                            Toast.makeText(Chef.this, "Please Enter User_name", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            flag1=true;
                        }
                        ...
                        {
                            Toast.makeText(Chef.this, "Please Enter the Password", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            flag2=true;
                        }
                        ...
                        {
                            Toast.makeText(Chef.this, "Please Enter Email or Contact Number", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            flag3=true;
                        }
                        ...
                        if(flag1==true && flag2==true && flag3==true )
                        {
                            ...
                            if (cond_checkbox.isChecked())
                            {
                                ...
                                if(isInserted == true) {
                                    Toast.makeText(Chef.this, "Data Inserted", Toast.LENGTH_LONG).show();
                                    Intent intent=new Intent(Chef.this,ChefDAta.class);
                                    startActivity(intent);
                                }
                                else
                                    Toast.makeText(Chef.this,"Data not Inserted",Toast.LENGTH_LONG).show();
